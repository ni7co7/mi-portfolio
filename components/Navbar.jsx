  ...
  return (
    <nav className="sticky top-0 z-50 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white px-12 py-8 shadow-lg">
     ...
     <h1 className="flex items-center space-x-2 font-bold text-2xl">
       <span className="text-violet-300" style={{
         textShadow: `
           1px 1px 0 #b28ddb,
           2px 2px 0 #9b79d1,
           3px 3px 0 #8445b9,
 ...
 */}        {/* Links */}
        <ul className="flex space-x-6">
          <li>
            <Link href="/" className="text-2xl hover:text-gray-200 transition">Home</Link>
          </li>
          <li>
            <Link href="/proyects" className="text-2xl hover:text-gray-200 transition">Proyects</Link>
          </li>
          <li>
            <Link href="/technologies" className="text-2xl hover:text-gray-200 transition">Technologies</Link>
          </li>
          <li>
            <Link href="/about" className="text-2xl hover:text-gray-200 transition">About</Link>
          </li>
        </ul>
